        ...
        <div className="flex justify-around">
          {socialLinks.map((social) => (
            <a
              ...
              className="text-gray-600 hover:text-transparent hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:bg-clip-text transition-all duration-300 transform hover:scale-125"
